...
#             ready.insert(RBTree.RBNode(current.get_vruntime))
#             return 1
#
#     return 0
#
...
#     return process
#
# def find_lowest_vruntime(ready):
#     minimum = 999999
#     process = ready[:1]
#
#     for current in ready:
#         if current.get_vruntime() < minimum:
#             minimum = current.get_vruntime()
#             process = current
#
#     return process
#
...
#
#
# def completely_fair_scheduler(ready):
#     target_latency = 5
#     dynamic_quantum = target_latency / len(ready)
#     process = find_lowest_vruntime(ready)
#     process.set_vruntime(process.get_vruntime() - (dynamic_quantum*process.get_weight()))
#
